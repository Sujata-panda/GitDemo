...
# open the file using open function and in Read only mode
f_pointer = open('C:\\Users\\sujata.panda\\PycharmProjects\\pythonProject\\Example_API\\PostJsonFile.json',mode='r')
